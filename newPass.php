...
<div id="container">
	<div id="content">
		<div style="width:940px;margin-top:10%;" id="content_assistant">
			<h1 align="right">Reiniciar password</h1>
			<hr/>
			...
			-->
			<div id="form-content">
				<form target="targetdiv" method="post" action="admin/resource/action_rem_pass.php" id="loginForm"> 
					<div class="cdr_form_content" style="margin-left:0px;width:320px;">
						<div class="rowform">
						...
						<div align="right" class="rowform">
							<input type="submit" value="Reiniciar password" id="send" name="send"/>
						</div>
					</div>
				</form>
				<div></div>
...
function processJson(data) {
	...
	if(data.aut == "ok"){
		alert("Se le acaba de enviar un correo con su contrase\xF1a.");
